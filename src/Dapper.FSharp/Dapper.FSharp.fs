...
type InnerJoinOn = 
    | JoinColumn of colName: string

type OuterJoinOn =
    | JoinFqColumn of fqColName: string
...
type Join =
    ...
    | InnerJoinOnMany of table:string * List<InnerJoinOn * OuterJoinOn>
    | LeftJoinOnMany of table:string * List<InnerJoinOn * OuterJoinOn>
